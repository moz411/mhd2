  ...
  class detect_language {
	...
	function detect_language() {
	  $this->available_languages = array(
		'bg_BG'         => array('bg|bulgarian', 'bulgarian-win1251'),
		...
		'en_US'         => array('en([-_][[:alpha:]]{2})?|english', 'english'),
		'es_ES'         => array('es([-_][[:alpha:]]{2})?|spanish', 'spanish'),
		'fr_FR'         => array('fr([-_][[:alpha:]]{2})?|french', 'french'),
		'it_IT'         => array('it|italian', 'italian'),
